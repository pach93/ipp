 ...
 * PUT     /api/syllabuses/:id          ->  upsert
 * PATCH   /api/syllabuses/:id          ->  patch
...
// Upserts the given Syllabus in the DB at the specified ID
export function upsert(req, res) {
  if(req.body._id) {
    delete req.body._id;
  }
  return Syllabus.findOneAndUpdate({_id: req.params.id}, req.body, {upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
