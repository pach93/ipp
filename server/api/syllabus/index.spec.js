...
var syllabusCtrlStub = {
  ...
  upsert: 'syllabusCtrl.upsert',
  patch: 'syllabusCtrl.patch',
...
describe('Syllabus API Router:', function() {
  ...
  describe('PUT /api/syllabuses/:id', function() {
    it('should route to syllabus.controller.upsert', function() {
      routerStub.put
        .withArgs('/:id', 'syllabusCtrl.upsert')
        .should.have.been.calledOnce;
    });
  });

  describe('PATCH /api/syllabuses/:id', function() {
    it('should route to syllabus.controller.patch', function() {
      routerStub.patch
        .withArgs('/:id', 'syllabusCtrl.patch')
        .should.have.been.calledOnce;
    });
  });
